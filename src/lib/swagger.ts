  ...
  const spec = createSwaggerSpec({
    ...
    definition: {
      ...
      info: {
        title: 'Polyswap API',
        version: '1.0.0',
        description: 'API for Polyswap - Decentralized prediction market order management with CoW Protocol integration',
      },
      servers: [
        {
        ...
        schemas: {
          ...
          Order: {
            ...
            properties: {
              ...
              owner: { type: 'string' },
              status: { type: 'string', enum: ['pending', 'active', 'filled', 'cancelled', 'expired'] },
