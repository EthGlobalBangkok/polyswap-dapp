 ...
 * STALE_AFTER_MS after creation. Shared sentinels are never canceled here:
 * an unconfirmed draft cannot have activated one, while another confirmed
 * order may still reference the same sentinel.
 */
