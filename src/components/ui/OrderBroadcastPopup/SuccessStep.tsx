    ...
    <div className={styles.stepContent}>
      ...
      {warningMessage && (
        <div
          ...
          style={{ backgroundColor: "#fff3cd", border: "1px solid #ffeaa7", marginTop: "16px" }}
        >
          <p style={{ color: "#856404", margin: "0" }}>⚠️ {warningMessage}</p>
        </div>
      )}

      <div className={styles.buttonGroup}>
        <button className={styles.secondaryButton} onClick={handleViewOnExplorer}>
          View on Explorer
        </button>
